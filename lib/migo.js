...
(function() {
  ...
  DB = (function() {
    ...
    DB.prototype.open = function(conn, autocb) {
      ...
      this.db.connect(function(_$$_11) {
        autocb(_$$_11);
      });
    };
    ...
    DB.prototype.drop = function(n, autocb) {
      var _this = this;
      this.q("DROP TABLE IF EXISTS " + n + "_migo_deleted;\nALTER TABLE " + n + " RENAME TO " + n + "_migo_deleted;", function(_$$_12) {
        autocb(_$$_12);
      });
    };
    ...
    DB.prototype.begin = function(autocb) {
      var _this = this;
      this.query("BEGIN", function(_$$_13) {
        autocb(_$$_13);
      });
    };
    ...
    DB.prototype.commit = function(autocb) {
      var _this = this;
      this.query("COMMIT", function(_$$_14) {
        autocb(_$$_14);
      });
    };
    ...
    DB.prototype.rollback = function(autocb) {
      var _this = this;
      this.query("ROLLBACK", function(_$$_15) {
        autocb(_$$_15);
      });
    };
  ...
  function init(conn) {
    ...
    function _migrate(args, autocb) {
      var answer, color, fn, fns, last_id, mig, name, nid, ward, ws, _,
        _this = this;
      last_id = args[0];
      if (last_id) {
    ...
    function _commit(autocb) {
      var _this = this;
      db.commit(function(_$$_8) {
        ok(_$$_8);
        fs.writeFile('migo.id', id, 'UTF-8', function(_$$_9) {
          ok(_$$_9);
          db.close(function(_$$_10) {
            ok(_$$_10);
            autocb(rl.close());
          });
        });
